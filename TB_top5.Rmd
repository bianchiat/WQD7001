...
df1$New_cases_RR.MDR<-as.numeric(as.character(df1$New_cases_RR.MDR))
```
...
```{r,echo=FALSE,max_height = "200px", max_width = '200px' }
...
df1%>%
  select(Country,New_cases_RR.MDR) %>%
  arrange(desc(New_cases_RR.MDR)) %>%
  head(5)%>%
